...
# Bonus gganimate example

Here is a basic gganimate example, in case you were interested! (Currently set to `eval=FALSE`, remove that to include it in the knitted document.)

```{r gganimate_example, fig.width=10, fig.height=5, eval=FALSE}
library(gganimate)
